...
public:
  ...
  explicit inline Vector(const Vector<int, 3>& v) {
    MATHFU_VECTOR3_INIT3(*this, static_cast<float>(v[0]), static_cast<float>(v[1]),
                         static_cast<float>(v[2]));
  }

  inline Vector(const simd4f& v) {
    MATHFU_VECTOR3_STORE3(v, *this);
  }
  ...
  inline Vector<float, 3> operator-() const {
    return Vector<float, 3>(simd4f_sub(simd4f_zero(), MATHFU_VECTOR3_LOAD3(*this)));
  }

  inline Vector<float, 3> operator*(const Vector<float, 3>& v) const {
    return Vector<float, 3>(simd4f_mul(MATHFU_VECTOR3_LOAD3(*this), MATHFU_VECTOR3_LOAD3(v)));
  }

  inline Vector<float, 3> operator/(const Vector<float, 3>& v) const {
    return Vector<float, 3>(simd4f_div(MATHFU_VECTOR3_LOAD3(*this), MATHFU_VECTOR3_LOAD3(v)));
  }

  inline Vector<float, 3> operator+(const Vector<float, 3>& v) const {
    return Vector<float, 3>(simd4f_add(MATHFU_VECTOR3_LOAD3(*this), MATHFU_VECTOR3_LOAD3(v)));
  }

  inline Vector<float, 3> operator-(const Vector<float, 3>& v) const {
    return Vector<float, 3>(simd4f_sub(MATHFU_VECTOR3_LOAD3(*this), MATHFU_VECTOR3_LOAD3(v)));
  }

  inline Vector<float, 3> operator*(const float& s) const {
    return Vector<float, 3>(simd4f_mul(MATHFU_VECTOR3_LOAD3(*this), simd4f_splat(s)));
  }

  inline Vector<float, 3> operator/(const float& s) const {
    return Vector<float, 3>(simd4f_div(MATHFU_VECTOR3_LOAD3(*this), simd4f_splat(s)));
  }

  inline Vector<float, 3> operator+(const float& s) const {
    return Vector<float, 3>(simd4f_add(MATHFU_VECTOR3_LOAD3(*this), simd4f_splat(s)));
  }

  inline Vector<float, 3> operator-(const float& s) const {
    return Vector<float, 3>(simd4f_sub(MATHFU_VECTOR3_LOAD3(*this), simd4f_splat(s)));
  }
  ...
  inline float LengthSquared() const {
    return simd4f_dot3_scalar(MATHFU_VECTOR3_LOAD3(*this), MATHFU_VECTOR3_LOAD3(*this));
  }
  ...
  static inline float DotProduct(const Vector<float, 3>& v1, const Vector<float, 3>& v2) {
    return simd4f_dot3_scalar(MATHFU_VECTOR3_LOAD3(v1), MATHFU_VECTOR3_LOAD3(v2));
  }

  static inline Vector<float, 3> CrossProduct(const Vector<float, 3>& v1,
                                              const Vector<float, 3>& v2) {
    return Vector<float, 3>(simd4f_cross3(MATHFU_VECTOR3_LOAD3(v1), MATHFU_VECTOR3_LOAD3(v2)));
  }

  static inline Vector<float, 3> HadamardProduct(const Vector<float, 3>& v1,
                                                 const Vector<float, 3>& v2) {
    return Vector<float, 3>(simd4f_mul(MATHFU_VECTOR3_LOAD3(v1), MATHFU_VECTOR3_LOAD3(v2)));
  }

  static inline Vector<float, 3> Lerp(const Vector<float, 3>& v1, const Vector<float, 3>& v2,
                                      float percent) {
    ...
    return Vector<float, 3>(
        simd4f_add(simd4f_mul(MATHFU_VECTOR3_LOAD3(one_minus_percent), MATHFU_VECTOR3_LOAD3(v1)),
...
#ifdef MATHFU_COMPILE_WITH_PADDING
    return Vector<float, 3>(simd4f_max(MATHFU_VECTOR3_LOAD3(v1), MATHFU_VECTOR3_LOAD3(v2)));
#else
...
#ifdef MATHFU_COMPILE_WITH_PADDING
    return Vector<float, 3>(simd4f_min(MATHFU_VECTOR3_LOAD3(v1), MATHFU_VECTOR3_LOAD3(v2)));
#else
